...
VL_ATTR_COLD void Vsc_dut___024root___eval_static(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___eval_static\n"); );
}

VL_ATTR_COLD void Vsc_dut___024root___eval_initial(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vtrigprevexpr___TOP__clk__0 = vlSelf->clk;
    vlSelf->__Vtrigprevexpr___TOP__reset_n__0 = vlSelf->reset_n;
}

VL_ATTR_COLD void Vsc_dut___024root___eval_final(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___eval_final\n"); );
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vsc_dut___024root___dump_triggers__stl(Vsc_dut___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vsc_dut___024root___eval_phase__stl(Vsc_dut___024root* vlSelf);

VL_ATTR_COLD void Vsc_dut___024root___eval_settle(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___eval_settle\n"); );
    // Init
...
#endif
            VL_FATAL_MT("tb_wrapper/sc_dut.sv", 4, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vsc_dut___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vsc_dut___024root___dump_triggers__stl(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vsc_dut___024root___eval_stl(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD bool Vsc_dut___024root___eval_phase__stl(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vsc_dut___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        Vsc_dut___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vsc_dut___024root___dump_triggers__ico(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vsc_dut___024root___dump_triggers__act(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vsc_dut___024root___dump_triggers__nba(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vsc_dut___024root___ctor_var_reset(Vsc_dut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsc_dut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsc_dut___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->sc_dut__DOT__u_fsm__DOT__grid_state_q = VL_RAND_RESET_I(2);
    vlSelf->sc_dut__DOT__u_fsm__DOT__battery_connected_q = VL_RAND_RESET_I(1);
    vlSelf->sc_dut__DOT__u_fsm__DOT__fault_flag_q = VL_RAND_RESET_I(1);
    vlSelf->sc_dut__DOT__u_fsm__DOT__data_valid_q = VL_RAND_RESET_I(1);
    vlSelf->sc_dut__DOT__u_fsm__DOT__check_wait_count = VL_RAND_RESET_I(2);
    vlSelf->sc_dut__DOT__u_safety__DOT__grid_state_enum = VL_RAND_RESET_I(2);
    vlSelf->sc_dut__DOT__u_safety__DOT__fault_flag_comb = VL_RAND_RESET_I(1);
    vlSelf->sc_dut__DOT__u_safety__DOT__fault_code_comb = VL_RAND_RESET_I(2);
