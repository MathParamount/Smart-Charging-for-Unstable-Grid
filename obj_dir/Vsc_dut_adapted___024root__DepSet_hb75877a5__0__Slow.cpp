...
VL_ATTR_COLD void Vsc_dut_adapted___024root___ctor_var_reset(Vsc_dut_adapted___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__voltage_history[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__sum_voltage = VL_RAND_RESET_I(32);
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__filter_volt = VL_RAND_RESET_I(16);
    ...
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__debug_sum = VL_RAND_RESET_I(16);
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__debug_adc = VL_RAND_RESET_I(16);
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__debug_h0 = VL_RAND_RESET_I(16);
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__debug_h1 = VL_RAND_RESET_I(16);
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__debug_h2 = VL_RAND_RESET_I(16);
    vlSelf->sc_dut_adapted__DOT__u_top__DOT__u_grid__DOT__debug_h3 = VL_RAND_RESET_I(16);
